  ...
  return (
    <div className="flex flex-row h-[3rem]">
      ...
      <div className="flex-col  gap-4 w-[0]  lg:w-[auto] lg:grow-[2] overflow-hidden flex lg:flex-row items-center justify-around">
        <Link href={"/"} className="text-2xl text-lightPurple font-bold">
          Página Principal
        </Link>
        <Link
          href={"/amazonas"}
      ...
      <div className="relative grow  flex flex-row justify-center">
        ...
        ></Image>
        {!closed && (
          <div className="text-xs md:text-lg absolute top-[100%] z-40 p-[1rem] lg:p-0 flex-col gap-4 bg-light w-auto lg:w-[0] lg:grow-[2] overflow-hidden flex lg:flex-row items-start justify-around">
            <Link href={"/"} className=" text-lightPurple font-bold">
              Página Principal
            </Link>
            ...
            <Link href={"/nosotros"} className="text-lightPurple font-bold">
              Quiénes somos
            </Link>
          </div>
        )}
