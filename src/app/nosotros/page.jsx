...
export function initialAnim(params, router) {
  ...
  tMap.add(
    gsap.to(".container__links", { width: "0%", zIndex: 10, duration: 1 }),
    0
  );
  tMap.add(
  ...
  tMap.add(
    gsap.to(".cesar_svg", { transformOrigin: "70% 10%", duration: 1 }),
    0
  );
        ...
        >
          ...
          >
            <h1 className="text-4xl font-bold">
              Alianza por la innovación pedagógica con uso de tecnologías para
              la paz
            </h1>
            <div className={`text-xl font-normal h-fit`}>
              <p>
                ...
                Convocatoria que tiene por objetivo apoyar el desarrollo de
                proyectos que busquen potenciar el Sistema Nacional de
                Laboratorios (SNL) a través de la conformación o fortalecimiento
                de estrategias de cooperación entre laboratorios de diferentes
              ...
              {!closed && (
                <>
                  ...
                  <p>
                    ...
                    607-C4 «Mejoramiento de la infraestructura de los
                    laboratorios para el avance de la Ciencia, la Tecnología y
                    la Innovación» del proyecto de inversión de la Vicerrectoría
                    de Investigación 2022-2024 «Armonización, fortalecimiento y
                    visibilidad de las funciones de investigación, extensión e
                    innovación para una gestión del conocimiento colectiva y
                    transformadora».
                  </p>
                  <br />
                  <p>
                    ...
                    conocimientos y tecnologías entre diversos laboratorios de
                    la Universidad Nacional de Colombia. Su objetivo principal
                    es dar visibilidad a los servicios que estos laboratorios
                    ofrecen, así como avanzar en la digitalización de sus
                    procesos de investigación e implementación de herramientas
                    tecnológicas. Esta alianza se basa en la amplia experiencia
                    en docencia, investigación y extensión de sus miembros,
                    centrándose en la construcción y desarrollo de la paz
                    territorial en regiones como Cesar, Amazonia y Cundinamarca.
                    Su propósito fundamental es contribuir a la resolución de
                    las necesidades relacionadas con la construcción de la paz
                    en estos territorios. Entre las soluciones que se buscan
                    implementar se incluyen la creación de contenido temático,
                    el desarrollo de soluciones tecnológicas y estrategias de
                    visibilización de los laboratorios participantes.
                  </p>
                  <br />
                  <p>
                    ...
                    como Cesar, Amazonia y Cundinamarca. Su propósito
                    fundamental es contribuir a la resolución de las necesidades
                    relacionadas con la construcción de la paz en estos
                    territorios. Entre las soluciones que se buscan implementar
                    se incluyen la creación de contenido temático, el desarrollo
                    de soluciones tecnológicas y estrategias de visibilización
