...
export function initialAnim(params, router){
  ...
  tMap.add(gsap.to(".cesar_svg", {transformOrigin:"40% 10%", duration: 1}),0)
...
export default function Home(props) {
  ...
  return (
    ...
    <GlobalLayout title={"La Paz"} subtitle={"Viaje hacia la construcción de entornos pacíficos y autónomos"} PrevButton={<PreviusPageButton handleBack={handleBack}/>}>
      <div className={"container__description mt-[2rem]  w-[0rem] max-w-[100vw] overflow-hidden flex flex-col justify-center items-center h-full " + 
                      "lg:mt-[0]"}>
        <div className={"w-[100%] px-[1rem] flex flex-col gap-[2rem] " + "lg:w-[50%]"}>
        <div className='flex  flex-row justify-end items-center'>
        <Image alt='recorrido virtual imagen' className='w-[0] sm:w-[100px] me-[-80px] z-10' width={"100"} height={"100"} src={"/icons/3dpath.svg"}/>
        <BtnIcons 
