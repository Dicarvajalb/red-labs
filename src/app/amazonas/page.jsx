...
export function initialAnim(params, router) {
  ...
  tMap.add(
    gsap.to(".amazonia_svg", { transformOrigin: "70% 120%", duration: 1 }),
    0
  );
  ...
  tMap.add(
    gsap.to([".map_svg>:not(.amazonia_svg)"], {
      position: "absolute",
      scale: 0,
      duration: 0.5,
    }),
  ...
  return (
    <>
      ...
      >
        <div
          className={
            "container__description w-0 opacity-0 px-[1rem] lg:px-[0] max-w-[100vw] overflow-hidden flex flex-col justify-center items-center h-full " +
            ""
          }
        >
          <div className={"w-[100%] " + "lg:w-[50%]"}>
            <p className="text-white text-2xl mb-10">
              <b>Seguridad y soberanía alimentaria</b>
              <br></br>
            ...
            <BtnIcons
              ...
              rightIcon={baseURL + "/icons/arrowRight.svg"}
              className={
                "w-[100%] bg-ligthAlt2 text-lightPurple font-bold hover:text-lightPurple " +
                "lg:w-[15rem"
              }
            >
